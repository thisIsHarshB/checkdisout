    ...
    return (
      <button
        className={cn(
          ...
          variants[variant],
          sizes[size],
          'transition-transform duration-200 hover:scale-105 focus:scale-105 active:scale-95 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none',
          className
        )}
        ref={ref}
